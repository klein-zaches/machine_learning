...
theta1_without_first_item = [zeros(size(Theta1,1),1) Theta1s];
theta2_without_first_item  = [zeros(size(Theta2s,1),1) Theta2s];

Theta1_grad=(1/m).*tridelta_1 + lambda/m * theta1_without_first_item;
Theta2_grad=(1/m).*tridelta_2 + lambda/m * theta2_without_first_item;
